...
urlpatterns = [
    ...
    path('listar-coletas/detalhes/<int:pk>', views.detalhar_coleta, name='detalhes_coleta'),
    path('listar-coletas/detalhes/<int:pk>', views.DetalharColeta.as_view(), name='detalhes_coleta_cbv'),

    path('listar-coletas/deletar/<int:pk>', views.deletar_coleta, name='deletar_coleta'),
    ...
    path('listar-criacoes/detalhes/<int:pk>', views.detalhar_criacao, name='detalhes_criacao'),
    path('listar-criacoes/detalhes-cbv/<int:pk>', views.DetalharCriacao.as_view(), name='detalhes_criacao-cbv'),

    path('listar-criacoes/deletar/<int:pk>', views.deletar_criacao, name='deletar_criacao'),
